...
static bool flushCalibration = false;
...
void loopNormal() {
  ...
  // Serial.print("\t");
  // Serial.print(fingerB._calibrated);
  // Serial.print("\t");
  // Serial.println(fingerC._calibrated);
    ...
    case 20:
      {
        ...
        if ((aTouching && bTouching && cTouching) || readUIButton()) {
          state = 30;
          delay(1000); // allow button to go low
