classdef gripperSet
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %****** 'Main' Functions for Obstacle Detection ******
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %** Search for contact points with the obstacle at a RANGE of
        %heights
        ...
        %** Take the search data obtained from probing the whole obstacle
        % and plot the points where contact was made
        ...
        %** Plot the grippers, keeping them steady if in contact
